...
void Player::BehindAvoidancePosition()
{
    ...
    //--------------------------------------------//
    //----------------中継１---------------------//
    behind_point_1.x = target.x + (((right.x * cosf(DirectX::XMConvertToRadians(290.0f))) + (forward.x * sinf(DirectX::XMConvertToRadians(290.0f)))) * length_radius);//敵の後ろ側
    behind_point_1.y = target.y;//敵の後ろ側
    behind_point_1.z = target.z + (((right.z * cosf(DirectX::XMConvertToRadians(290.0f))) + (forward.z * sinf(DirectX::XMConvertToRadians(290.0f)))) * length_radius);//敵の後ろ側
    //--------------------------------------------//
    //----------------中継2---------------------//
    behind_point_2.x = target.x + (((right.x * cosf(DirectX::XMConvertToRadians(320.0f))) + (forward.x * sinf(DirectX::XMConvertToRadians(320.0f)))) * length_radius);//敵の後ろ側
    behind_point_2.y = target.y;//敵の後ろ側
    behind_point_2.z = target.z + (((right.z * cosf(DirectX::XMConvertToRadians(320.0f))) + (forward.z * sinf(DirectX::XMConvertToRadians(320.0f)))) * length_radius);//敵の後ろ側
